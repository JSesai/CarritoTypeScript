...
export default function App() {
  const {data, cart, addToCart, removeFromCart, increaseQuantity, decreaseQuantity, clearCart, isEmpty, total} = useCart() //obtiene el estado de autenticacion de useCart
